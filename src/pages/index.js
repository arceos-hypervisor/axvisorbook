    ...
    <section className="platforms-section">
      <div className="container">
        <div className="section-header">
          ...
          <p className="section-subtitle">
            <Translate>已在多种硬件平台上验证，提供完整的固件和文档支持</Translate>
          </p>
        </div>
        
        <div className="platforms-layout">
          {/* 虚拟化平台 - 左侧 */}
          <div className="platform-column platform-column-left">
            <div className="platform-category">
              <div className="platform-category-header">
                <div className="platform-category-icon">
                ...
                <p className="platform-category-description">
                  <Translate>在虚拟化环境中进行开发和测试</Translate>
                </p>
              </div>
              <div className="platform-list">
                <div className="platform-card">
                  <div className="platform-card-header">
                    ...
                    <div className="platform-info">
                      <h4>QEMU AArch64</h4>
                      <p>完整的虚拟化功能支持，适用于 ARM64 架构</p>
                    </div>
                  </div>
                  <div className="platform-card-actions">
                    <a href="#" className="platform-button platform-button-download">
                    ...
                    <a href={useBaseUrl("docs/quickstart/qemu/aarch64")} className="platform-button platform-button-docs">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
                        <line x1="16" y1="13" x2="8" y2="13"></line>
                ...
                <div className="platform-card">
                  <div className="platform-card-header">
                    ...
                    <div className="platform-info">
                      <h4>QEMU x86_64</h4>
                      <p>完整的 x86_64 指令集支持，适用于 Intel/AMD 架构</p>
                    </div>
                  </div>
                  <div className="platform-card-actions">
                    <a href="#" className="platform-button platform-button-download">
                    ...
                    <a href={useBaseUrl("docs/quickstart/qemu/x86_64")} className="platform-button platform-button-docs">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
                        <line x1="16" y1="13" x2="8" y2="13"></line>
          ...
          {/* 物理硬件平台 - 右侧 */}
          <div className="platform-column platform-column-right">
            <div className="platform-category">
              <div className="platform-category-header">
                <div className="platform-category-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <p className="platform-category-description">
                  <Translate>在实际硬件设备上部署和运行</Translate>
                </p>
              </div>
              <div className="platform-list">
                <div className="platform-card">
                  ...
                  <div className="platform-card-actions">
                    ...
                    <a href={useBaseUrl("docs/manual/deploy/evm3588")} className="platform-button platform-button-docs">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
                        <line x1="16" y1="13" x2="8" y2="13"></line>
                ...
                <div className="platform-card">
                  ...
                  <div className="platform-card-actions">
                    ...
                    <a href={useBaseUrl("docs/manual/deploy/phytiumpi")} className="platform-button platform-button-docs">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                        <polyline points="14 2 14 8 20 8"></polyline>
                        <line x1="16" y1="13" x2="8" y2="13"></line>
