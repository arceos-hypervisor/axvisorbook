...
![](./img_rk3588j/img-2.png)
![](./img_rk3588j/img-3.png)
![](./img_rk3588j/img-4.png)
![](./img_rk3588j/img-5.png)
![](./img_rk3588j/img-6.png)
...
![](./img_rk3588j/img-7.png)
 
注意串口波特率需要设置为1500000

4. 从Uboot进入烧写模式：

![](./img_rk3588j/img-8.png)
 
5. 长按REC键进入烧写模式：

![](./img_rk3588j/img-9.png)
![](./img_rk3588j/img-10.png)

6. 在空白处右键，选择Load Config进入配置选择， 

![](./img_rk3588j/img-11.png)
 
7. 选择rk3588-param.txt配置 

![](./img_rk3588j/img-12.png)
 
8. 勾选boot，并填入`boot.img`的绝对路径，点击run即可烧入镜像
 
![](./img_rk3588j/img-13.png)
